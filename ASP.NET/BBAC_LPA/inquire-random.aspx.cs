...
public partial class inquire_random : System.Web.UI.Page
{
    static SqlConnection con = new SqlConnection("server=localhost;database=BBAC_LPA;uid=sa;pwd=123;");
    SqlDataAdapter da = null;
    static string sql = null;
    public DateTime st = DateTime.Parse(System.DateTime.Now.Year.ToString() + "-1" + "-1");
    public DateTime fn = DateTime.Parse(System.DateTime.Now.Year.ToString() + "-1" + "-1");
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterClientScriptBlock(UpdatePanel2, this.GetType(), "click", "alert('请填写完整的日期！')", true);
            return;
        }
        SqlDataAdapter da = null;
        try
        {
            this.st = Convert.ToDateTime(TextBox2.Text);
            this.fn = Convert.ToDateTime(TextBox3.Text);            
            Session["begin"] = this.st;
            Session["end"] = this.fn;
            ...
            {
                new SqlParameter("@st", this.st),
                new SqlParameter("@fn", this.fn)
            };
    ...
    protected void Dropdownlist2_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        SqlParameter[] para = new SqlParameter[]
        {
                new SqlParameter("@st", Session["begin"].ToString()),
                new SqlParameter("@fn", Session["end"].ToString()),
    ...
    public void export(string fileType, string fileName)
    {
        ...
        sw.WriteLine("Custom" + "\t" + ddl2.SelectedValue + "\t" + ddl3.SelectedValue + "\t" +
