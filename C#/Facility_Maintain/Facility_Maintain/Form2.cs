...
namespace Facility_Maintain
{
    public partial class Form2 : Form
    {
        ...
        public void Form2_Fill()
        {
            ...
            string sql = "select * from 维修记录表 where ID = " + index;
            ...
            try
            {
                ...
                textBox8.Text = Convert.ToDateTime(reader.GetValue(1)).ToString("yyyy-MM-dd");
                textBox9.Text = Convert.ToDateTime(reader.GetValue(2)).ToString("yyyy-MM-dd");
                textBox1.Text = Convert.ToString(reader.GetValue(4));
                textBox6.Text = Convert.ToString(reader.GetValue(3));
                textBox7.Text = Convert.ToString(reader.GetValue(8));
                textBox5.Text = Convert.ToString(reader.GetValue(10));
                textBox2.Text = Convert.ToString(reader.GetValue(6));
                textBox3.Text = Convert.ToString(reader.GetValue(7));
                textBox4.Text = Convert.ToString(reader.GetValue(9));
                textBox10.Text = Convert.ToString(reader.GetValue(5)) + "分钟";
                //form
                ...
                {
                    if (reader.GetValue(11 + picnum).ToString() == "")
                        break;
                }
