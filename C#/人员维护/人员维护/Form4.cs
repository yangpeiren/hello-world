...
namespace 人员维护
{
    public partial class Form4 : Form
    {
        ...
        public bool picker1 = false;
        public bool picker2 = false;

        public bool picker3 = false;
        public bool picker4 = false;
        public bool picker5 = false;

        public bool picker7 = false;
        public bool picker8 = false;
        public bool picker9 = false;
        public bool picker10 = false;

        public bool picker11 = false;
        public bool picker12 = false;
        public bool picker13 = false;
        public bool picker14 = false;

        public bool picker15 = false;
        public bool picker16 = false;
        public bool picker17 = false;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string sql = "update 人员管理 set 编码 = @编码,姓名 = @姓名,相片 = @相片," +
                        "性别 = @性别,出生日期 = @出生日期,工段名称 = @工段名称,身份证号 = @身份证号," +
                        "户口所在地 = @户口所在地,民族 = @民族,班次 = @班次,婚否 = @婚否"
        ...
        {
            if (textBox16.Text == "" || textBox18.Text == "" || textBox19.Text == "")
            {
                MessageBox.Show("请填写完整信息！", "错误");
                return;
            }
        ...
        {
            if (textBox26.Text!="" && comboBox9.SelectedIndex == 0
                || comboBox10.SelectedIndex == 0 || textBox27.Text == ""
